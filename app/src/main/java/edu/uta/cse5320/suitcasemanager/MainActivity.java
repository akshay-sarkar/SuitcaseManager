...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Suitcase Manager: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this /* FragmentActivity */,  new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult result) {
                        Log.e(TAG, "Failed Connection " + result.hasResolution());
        ...
        //commonData.getInstance(mGoogleApiClient);
...
/*
    public void onRegisterPress(View view){
        ...
        mAuth.createUserWithEmailAndPassword(mUsername.getText().toString(), mPassword.getText().toString())
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Log.d(TAG,"Excepetion : "+ task.getException().toString());
                        }
                    }
                });
    }
    ...
    public void onLoginPress(View view){
        ...
        mAuth.signInWithEmailAndPassword(mUsername.getText().toString(), mPassword.getText().toString())
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Toast.makeText(ctx, "signInWithEmail:onComplete:" + task.isSuccessful(),
                ...
                if (state != NetworkInfo.State.CONNECTED) {
                    ...
                    alertDialog.setPositiveButton("OK",new DialogInterface.OnClickListener(){
                        public void onClick(DialogInterface dialog, int id) {
                            Intent loginScreenIntent = new Intent(MainActivity.this, MainActivity.class);
